...
const UpcomingCard = ({ booking }) => {
  ...
  return (
    <div className="flex items-start gap-4 bg-white rounded-xl border border-stone-200 p-4 hover:shadow-sm transition-shadow">
      {/* Date pill */}
      <div className="flex flex-col items-center justify-center bg-rose-600 text-white rounded-xl px-3 py-2 min-w-[52px] text-center">
    ...
    <form onSubmit={handleSearch} className="flex gap-2">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full pl-9 pr-4 py-2.5 text-sm border border-stone-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-rose-100 focus:border-rose-400 transition-colors bg-white"
        />
      </div>
      <button
        type="submit"
        className="inline-flex items-center gap-1.5 bg-stone-900 hover:bg-rose-700 text-white text-sm font-semibold px-4 py-2.5 rounded-lg transition-colors shadow-sm"
      >
...
const CustomerDashboard = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-8">
      ...
      {/* ── Hero Banner ── */}
      <div className="bg-gradient-to-br from-rose-600 via-rose-700 to-rose-950 text-white rounded-3xl p-6 md:p-8 shadow-lift relative overflow-hidden">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="space-y-2">
            <span className="text-gold-200 text-xs font-bold flex items-center gap-1.5 uppercase tracking-widest">
